...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Simulate successful login - in a real app, you would set auth state and redirect
      ...
      <div className="max-w-md w-full space-y-8 mx-auto">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-400">
            Or{' '}
            <Link to="/signup" className="font-medium text-accent-blue hover:text-blue-400">
          ...
          <div className="rounded-md -space-y-px">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-t-md relative block w-full px-3 py-3 bg-gray-800 border border-gray-700 placeholder-gray-500 text-white focus:outline-none focus:ring-accent-blue focus:border-accent-blue focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <input
                ...
                required
                className="appearance-none rounded-b-md relative block w-full px-3 py-3 bg-gray-800 border border-t-0 border-gray-700 placeholder-gray-500 text-white focus:outline-none focus:ring-accent-blue focus:border-accent-blue focus:z-10 sm:text-sm"
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-primary-bg text-gray-400">Or continue with</span>
            </div>
          </div>
